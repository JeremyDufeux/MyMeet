...
public class DummyMeetingGenerator {
    ...
    public static List<Meeting> generateMeetings(List<Room> rooms) {
        ...
        DUMMY_MEETING_LIST.add(new Meeting(
                ...
                new ArrayList<>(Arrays.asList(new Participant("jeremy.dufeux@gmail.com"), new Participant("jeremy.dufeux2@gmail.com"), new Participant("jeremy.dufeux3@gmail.com"))),
                rooms.get(0)));
        ...
        DUMMY_MEETING_LIST.add(new Meeting(
                ...
                new ArrayList<>(Arrays.asList(new Participant("jeremy.dufeux@gmail.com"), new Participant("jeremy.dufeux2@gmail.com"))),
                rooms.get(1)));
        ...
        DUMMY_MEETING_LIST.add(new Meeting(
                ...
                new ArrayList<>(Arrays.asList(new Participant("jeremy.dufeux@gmail.com"), new Participant("jeremy.dufeux2@gmail.com"), new Participant("jeremy.dufeux3@gmail.com"), new Participant("jeremy.dufeux4@gmail.com"))),
                rooms.get(4)));
